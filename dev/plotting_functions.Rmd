...
orgDb <- org.Hs.eg.db
frares<-as.data.table(FRASER::results(fds))
plotBamCoverageFromResultTable(fds, result=frares[1,], show_full_gene=TRUE, txdb=txdb, orgDb=orgDb, control_samples="IVCT-53-M")
##need to specify path to the BAM files
```
